...
En la \autoref{tab:tipoAtributos} hacemos un analisis del tipo de atributos tenemos para luego usar tecnicas para la categorización, el la \autoref{tab:tipoVariable} mostramos el tipo de variables que tenemos. En la \autoref{tab:valoresNulos} mostramos que no tenemos valores nulos.
